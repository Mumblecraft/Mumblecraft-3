...
var tagGen = [
    ...
    "copper=ingots,nuggets,dusts,ores,gears,plates,rods",
    "tin=storage_blocks,ingots,nuggets,dusts,ores",
    "aluminum=ingots,nuggets,dusts,ores,plates",
    "lead=ingots,nuggets,dusts,ores,gears,plates,rods",
    "silver=ingots,nuggets,dusts,ores,plates,rods",
    "nickel=ingots,nuggets,dusts,ores,plates,rods",
    "bronze=storage_blocks,ingots,nuggets,dusts,ores,gears,plates",
    "steel=ingots,nuggets,dusts,ores,gears,plates,rods",
    "uranium=ingots,nuggets,dusts,ores,plates",
	...
	"constantan=ingots,nuggets,dusts,ores,plates,rods",
	"electrum=ingots,nuggets,dusts,ores,plates,rods",
	"wood=dusts",
	"quartz=dusts",
	"certus_quartz=dusts",
